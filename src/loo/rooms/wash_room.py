...
class WashRoom(AbstractRoom):
    ...
    def get_detailed_description(self):
        return "You see a coin on the floor. " + "<br/>" + "You also see an incredibly nasty sink with an undefinable substance in it. Ew!" + "<br/>" + "You notice a <mark>DoD</mark> on the door." + "</br>" + "On the other side of the room you see another <mark>door</mark>." + "</br>" + "Oh, and there's a blockchain in the corner. Interesting.."
